...
void Scene::buildDefaultScene () {
    ...
    Material groundMat(0.8f, 0.2f, 0.5f, Vec3Df(0.5f, 0.5f, 0.5f));
    Object ground (groundMesh, groundMat);    
    objects.push_back (ground);
    Mesh ramMesh;
    ramMesh.loadOFF ("models/ram.off");
    Material ramMat (1.f, 1.0f, 0.0f, Vec3Df (1.f, .6f, .2f));
 ...
 /*   Mesh monkeyMesh;
    ...
    Material rhinoMat (1.0f, 0.2f,0.0f, Vec3Df (0.6f, 0.6f, 0.7f));
    ...
    Material gargMat (0.7f, 0.4f,0.0f, Vec3Df (0.5f, 0.8f, 0.5f));
...
/*
    ...
    Material groundMat;
    Object testObject (test, groundMat);    
